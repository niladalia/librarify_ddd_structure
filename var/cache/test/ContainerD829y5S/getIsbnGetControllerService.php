...
class getIsbnGetControllerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.wNFWkRy'] ?? $container->load('get_ServiceLocator_WNFWkRyService'))->withContext('App\\Isbn\\Intrastructure\\Controllers\\IsbnGetController', $container));
