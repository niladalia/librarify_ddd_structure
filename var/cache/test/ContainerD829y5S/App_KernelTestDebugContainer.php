...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Authors\\Infrastructure\\Controllers\\AuthorsDeleteController' => 'getAuthorsDeleteControllerService',
            'App\\Authors\\Infrastructure\\Controllers\\AuthorsGetController' => 'getAuthorsGetControllerService',
            'App\\Authors\\Infrastructure\\Controllers\\AuthorsPostController' => 'getAuthorsPostControllerService',
            'App\\Books\\Infrastructure\\Controllers\\BookGetController' => 'getBookGetControllerService',
            'App\\Books\\Infrastructure\\Controllers\\BooksDeleteController' => 'getBooksDeleteControllerService',
            'App\\Books\\Infrastructure\\Controllers\\BooksGetController' => 'getBooksGetControllerService',
            'App\\Books\\Infrastructure\\Controllers\\BooksPatchController' => 'getBooksPatchControllerService',
            'App\\Books\\Infrastructure\\Controllers\\BooksPostController' => 'getBooksPostControllerService',
            'App\\Books\\Infrastructure\\Controllers\\BooksPutController' => 'getBooksPutControllerService',
            'App\\Isbn\\Intrastructure\\Controllers\\IsbnGetController' => 'getIsbnGetControllerService',
            ...
            'monolog.logger.messenger_audit' => 'getMonolog_Logger_MessengerAuditService',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.exception', [#[\Closure(name: 'App\\Shared\\Infrastructure\\Symfony\\ApiExceptionListener')] fn () => ($container->privates['App\\Shared\\Infrastructure\\Symfony\\ApiExceptionListener'] ??= new \App\Shared\Infrastructure\Symfony\ApiExceptionListener()), 'onKernelException'], 0);
        ...
        $instance->addListener('App\\Books\\Domain\\BookDeletedDomainEvent', [#[\Closure(name: 'App\\Authors\\Application\\Delete\\DeleteAuthorOnBookDelete')] fn () => ($container->privates['App\\Authors\\Application\\Delete\\DeleteAuthorOnBookDelete'] ?? $container->load('getDeleteAuthorOnBookDeleteService')), '__invoke'], 0);
        $instance->addListener('App\\Books\\Domain\\BookCreatedDomainEvent', [#[\Closure(name: 'App\\Books\\Application\\Create\\BookCreatedEventSubscriber')] fn () => ($container->privates['App\\Books\\Application\\Create\\BookCreatedEventSubscriber'] ?? $container->load('getBookCreatedEventSubscriberService')), 'logCreation'], 0);
        $instance->addListener('App\\Books\\Domain\\BookCreatedDomainEvent', [#[\Closure(name: 'App\\Books\\Application\\Create\\BookCreatedEventSubscriber')] fn () => ($container->privates['App\\Books\\Application\\Create\\BookCreatedEventSubscriber'] ?? $container->load('getBookCreatedEventSubscriberService')), 'sendMail'], 10);
        $instance->addListener('App\\Books\\Domain\\BookDeletedDomainEvent', [#[\Closure(name: 'App\\Shared\\Application\\DeleteFileOnBookDelete')] fn () => ($container->privates['App\\Shared\\Application\\DeleteFileOnBookDelete'] ?? $container->load('getDeleteFileOnBookDeleteService')), '__invoke'], 0);
    ...
    {
        $a = ($container->privates['debug.traced.messenger.bus.event.async.inner'] ?? self::getDebug_Traced_Messenger_Bus_Event_Async_InnerService($container));
    ...
    protected static function get_Doctrine_Orm_DefaultMetadataDriverService($container)
    {
        ...
        $a->addDriver($b, 'App\\Books\\Domain');
        $a->addDriver($b, 'App\\Authors\\Domain');
        $a->addDriver($b, 'App\\Categories\\Domain');
    ...
    /**
     * Gets the private '.service_locator.t8nXrpb' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_T8nXrpbService($container)
    {
        return $container->privates['.service_locator.t8nXrpb'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    protected static function getArgumentResolver_RequestPayloadService($container, $lazyLoad = true)
    {
        ...
        return ($lazyLoad->__construct(($container->privates['serializer'] ?? self::getSerializerService($container)), ($container->privates['debug.validator'] ?? self::getDebug_ValidatorService($container)), NULL) && false ?: $lazyLoad);
    }
    ...
    {
        $container->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('MvEy7y5SMM', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $container->privates['cache.messenger.restart_workers_signal.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FhF9vB-h14', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RyOiqtp4IL', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_is_granted_attribute_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('a2NEKa+HrR', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9gLzmw4xkB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ft8NpsJBXO', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('41AIa+bT+y', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('otRHfFkNnR', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDataCollector_MessengerService($container)
    {
        ...
        $instance->registerBus('messenger.bus.event.async', ($container->services['messenger.default_bus'] ?? self::getMessenger_DefaultBusService($container)));
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Authors\\Infrastructure\\Controllers\\AuthorsDeleteController', 'App\\Authors\\Infrastructure\\Controllers\\AuthorsGetController', 'App\\Authors\\Infrastructure\\Controllers\\AuthorsPostController', 'App\\Books\\Infrastructure\\Controllers\\BookGetController', 'App\\Books\\Infrastructure\\Controllers\\BooksDeleteController', 'App\\Books\\Infrastructure\\Controllers\\BooksGetController', 'App\\Books\\Infrastructure\\Controllers\\BooksPatchController', 'App\\Books\\Infrastructure\\Controllers\\BooksPostController', 'App\\Books\\Infrastructure\\Controllers\\BooksPutController', 'App\\Isbn\\Intrastructure\\Controllers\\IsbnGetController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private 'debug.traced.messenger.bus.event.async.inner' shared service.
     *
     * @return \Symfony\Component\Messenger\MessageBus
     */
    protected static function getDebug_Traced_Messenger_Bus_Event_Async_InnerService($container)
    {
        return $container->privates['debug.traced.messenger.bus.event.async.inner'] = new \Symfony\Component\Messenger\MessageBus(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['messenger.bus.event.async.middleware.traceable'] ?? $container->load('getMessenger_Bus_Event_Async_Middleware_TraceableService'));
            yield 1 => ($container->privates['messenger.bus.event.async.middleware.add_bus_name_stamp_middleware'] ??= new \Symfony\Component\Messenger\Middleware\AddBusNameStampMiddleware('messenger.bus.event.async'));
            ...
            yield 5 => ($container->privates['messenger.bus.event.async.middleware.send_message'] ?? $container->load('getMessenger_Bus_Event_Async_Middleware_SendMessageService'));
            yield 6 => ($container->privates['messenger.bus.event.async.middleware.handle_message'] ?? $container->load('getMessenger_Bus_Event_Async_Middleware_HandleMessageService'));
        }, 7));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setEntityNamespaces(['App\\Books\\Domain' => 'App\\Books\\Domain', 'App\\Authors\\Domain' => 'App\\Authors\\Domain', 'App\\Categories\\Domain' => 'App\\Categories\\Domain']);
    ...
    {
        return $container->privates['doctrine.orm.default_entity_manager.validator_loader'] = new \Symfony\Bridge\Doctrine\Validator\DoctrineLoader(($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)), '{^App\\\\Entity\\\\}');
    }
    ...
    {
        $container->privates['doctrine.orm.default_xml_metadata_driver'] = $instance = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver([(\dirname(__DIR__, 4).'/src/Books/Infrastructure/Persistence/Doctrine') => 'App\\Books\\Domain', (\dirname(__DIR__, 4).'/src/Authors/Infrastructure/Persistence/Doctrine') => 'App\\Authors\\Domain', (\dirname(__DIR__, 4).'/src/Categories/Infrastructure/Persistence/Doctrine') => 'App\\Categories\\Domain'], '.orm.xml', true);
    ...
    {
        $a = ($container->privates['.service_locator.t8nXrpb'] ?? self::get_ServiceLocator_T8nXrpbService($container));
    ...
    {
        return $container->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([($container->privates['serializer.denormalizer.unwrapping'] ?? self::getSerializer_Denormalizer_UnwrappingService($container)), ($container->privates['serializer.normalizer.flatten_exception'] ??= new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer()), ($container->privates['serializer.normalizer.problem'] ??= new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: NULL)), ($container->privates['serializer.normalizer.uid'] ??= new \Symfony\Component\Serializer\Normalizer\UidNormalizer()), ($container->privates['serializer.normalizer.datetime'] ??= new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer()), ($container->privates['serializer.normalizer.constraint_violation_list'] ?? self::getSerializer_Normalizer_ConstraintViolationListService($container)), ($container->privates['serializer.normalizer.datetimezone'] ??= new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer()), ($container->privates['serializer.normalizer.dateinterval'] ??= new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer()), ($container->privates['serializer.normalizer.form_error'] ??= new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer()), ($container->privates['serializer.normalizer.backed_enum'] ??= new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer()), ($container->privates['serializer.normalizer.data_uri'] ??= new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL)), ($container->privates['serializer.normalizer.json_serializable'] ??= new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL)), ($container->privates['serializer.denormalizer.array'] ??= new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer()), ($container->privates['serializer.normalizer.object'] ?? self::getSerializer_Normalizer_ObjectService($container))], [($container->privates['serializer.encoder.xml'] ??= new \Symfony\Component\Serializer\Encoder\XmlEncoder()), ($container->privates['serializer.encoder.json'] ??= new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL)), ($container->privates['serializer.encoder.yaml'] ??= new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL)), ($container->privates['serializer.encoder.csv'] ??= new \Symfony\Component\Serializer\Encoder\CsvEncoder())]);
    }
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addYamlMappings([(\dirname(__DIR__, 4).'/config/validator/Author.orm.yml'), (\dirname(__DIR__, 4).'/config/validator/Book.orm.yml'), (\dirname(__DIR__, 4).'/config/validator/Category.orm.yml'), (\dirname(__DIR__, 4).'/config/validator/CategoryDto.yaml'), (\dirname(__DIR__, 4).'/config/validator/author.yaml'), (\dirname(__DIR__, 4).'/config/validator/book.yaml'), (\dirname(__DIR__, 4).'/config/validator/bookDto.yaml'), (\dirname(__DIR__, 4).'/config/validator/category.yaml')]);
    ...
    protected static function getValidator_PropertyInfoLoaderService($container)
    {
        ...
        return $container->privates['validator.property_info_loader'] = new \Symfony\Component\Validator\Mapping\Loader\PropertyInfoLoader($a, $a, $a, '{^App\\\\Entity\\\\}');
    }
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'app.api_token' => $container->getEnv('resolve:APP_API_TOKEN'),
