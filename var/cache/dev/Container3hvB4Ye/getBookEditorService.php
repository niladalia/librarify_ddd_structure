...
class getBookEditorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Books\\Application\\Edit\\BookEditor'] = new \App\Books\Application\Edit\BookEditor(($container->privates['App\\Books\\Infrastructure\\Persistence\\DoctrineBookRepository'] ?? $container->load('getDoctrineBookRepositoryService')), $a, ($container->privates['App\\Books\\Application\\UploadFile\\BookFileUploader'] ?? $container->load('getBookFileUploaderService')), ($container->privates['App\\Books\\Application\\Find\\BookFinder'] ?? $container->load('getBookFinderService')), new \App\Books\Application\Update\UpdateBookCategory(new \App\Categories\Application\Find\CategoryFinder($b), new \App\Categories\Application\Create\CategoryCreator($b)), ($container->privates['App\\Books\\Application\\Update\\UpdateBookAuthor'] ?? $container->load('getUpdateBookAuthorService')));
    }
}
