...
class getMessenger_Transport_AmqpService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.transport.amqp'] = $a->createTransport($container->getEnv('MESSENGER_TRANSPORT_DSN'), ['exchange' => ['name' => 'exchange_librarify', 'type' => 'topic'], 'queues' => [], 'transport_name' => 'amqp'], new \App\Shared\Infrastructure\Event\DomainEventJsonSerializer());
    }
}
