...
class __TwigTemplate_ec1b537fd7fd230f18f3b7baea93fd2a extends Template
{
    private $source;
    private $macros = [];
    ...
    <tbody>
        ...
        $context['_seq'] = twig_ensure_traversable(twig_sort_filter($this->env, twig_get_array_keys_filter((isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 9, $this->source); })()))));
...
", "@WebProfiler/Profiler/table.html.twig", "/var/www/librarify_ddd_structure/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/table.html.twig");
    }
}
