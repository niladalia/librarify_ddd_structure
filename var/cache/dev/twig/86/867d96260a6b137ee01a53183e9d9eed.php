...
class __TwigTemplate_2650b1fe8f5d141d6ef770d677d00dae extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/notifier.html.twig", "/var/www/librarify_ddd_structure/vendor/symfony/web-profiler-bundle/Resources/views/Collector/notifier.html.twig");
    }
}
