...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Api\\BooksController' => 'getBooksControllerService',
            'App\\Controller\\Api\\IsbnController' => 'getIsbnControllerService',
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(($container->privates['doctrine.orm.default_xml_metadata_driver'] ?? self::getDoctrine_Orm_DefaultXmlMetadataDriverService($container)), 'App\\Entity');
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.exception', [#[\Closure(name: 'App\\EventListener\\ApiExceptionListener')] fn () => ($container->privates['App\\EventListener\\ApiExceptionListener'] ??= new \App\EventListener\ApiExceptionListener()), 'onKernelException'], 0);
        ...
        $instance->addListener('App\\Event\\BookCreatedDomainEvent', [#[\Closure(name: 'App\\EventSubscriber\\Book\\BookCreatedEventSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\Book\\BookCreatedEventSubscriber'] ?? $container->load('getBookCreatedEventSubscriberService')), 'logCreation'], 0);
        $instance->addListener('App\\Event\\BookCreatedDomainEvent', [#[\Closure(name: 'App\\EventSubscriber\\Book\\BookCreatedEventSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\Book\\BookCreatedEventSubscriber'] ?? $container->load('getBookCreatedEventSubscriberService')), 'sendMail'], 10);
    ...
    {
        $container->privates['doctrine.orm.default_xml_metadata_driver'] = $instance = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver([(\dirname(__DIR__, 4).'/config/doctrine') => 'App\\Entity'], '.orm.xml', true);
